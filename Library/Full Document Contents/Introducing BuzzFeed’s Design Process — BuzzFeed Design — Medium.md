---
Author: Tom Harman
Full Title: Introducing BuzzFeed’s Design Process — BuzzFeed Design — Medium
Category: #articles
Publication date: 2016-08-03
URL: https://medium.com/buzzfeed-design/introducing-buzzfeeds-design-process-4fefbdcd83ea#.2xuj2xcw3
Summary: BuzzFeed has introduced a new design process to improve communication and clarity in projects. This process includes five phases: Define, Explore, Refine, Build, and Learn, which help designers adapt and stay on track. By establishing a shared vocabulary, the team aims to enhance collaboration and feedback throughout the design lifecycle.
---

![rw-book-cover](https://miro.medium.com/v2/da:true/resize:fit:480/1*5rSrPiduxfKUYFpr_tcuMg.gif)

# Notes

[[Tom Harman - Introducing BuzzFeed’s Design Process — BuzzFeed Design — Medium]]

***

The word *“process”* appears 44 times in [our roles doc](https://medium.com/buzzfeed-design/buzzfeed-product-design-roles-2-0-6fe445078a74#.54xzf4ffw) — our reference for evaluating designers — and only increases its prevalence as a designer grows in seniority. So, why is having a unified process important? And, what does BuzzFeed’s design process look like? This post details the shiny new process we recently rolled out and how we’re aiming to increase the chance of our projects unfolding like the synchronized divers below.

![](https://miro.medium.com/v2/resize:fit:480/1*5rSrPiduxfKUYFpr_tcuMg.gif)
![](https://miro.medium.com/v2/resize:fit:312/1*_gLKTbmnJtjoLBRR-Jo1wA.gif)👈 when a project goes smoothly / 👉 when a project doesn’t go smoothly
...
![](https://miro.medium.com/v2/resize:fit:700/1*DdDKvNqNTixQ07sE2WBZDg.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*JXsiqDXg4nF8nGP1sa1zpw.gif)Note the overlapping phases, out of order sequence and dates on the x-axis, all helping this technique scale to a variety of projects.
...
![](https://miro.medium.com/v2/resize:fit:700/1*zConK3Qqoc3CsCTAzMzEMw.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*9RGPc46tN6vZ4Ss04E0ycA.gif)
...
![](https://miro.medium.com/v2/resize:fit:700/1*24T08UxcyVjsCDfFA4UgGg.jpeg)👈 [Jac](https://twitter.com/oiyana) prefers to make her own banner ads / 👉 [Allison](https://twitter.com/allisonchefec) likes to keep humanity at the core of her process
#### Next Steps
...
*Feel free to take what’s valuable and iterate on what’s missing. I’d love to hear how you get on so why not ping me* [*@tomharman*](http://twitter.com/tomharman) *to let me know which pieces have proven effective for you?*
