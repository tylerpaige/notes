---
Author: jackcheng.com
Full Title: The Slow Web
Category: #articles
Publication date: 2012-06-01
URL: https://jackcheng.com/the-slow-web/
Summary: The Slow Web Movement promotes a more thoughtful and less frantic online experience, contrasting with the Fast Web's overwhelming pace. It values timeliness over real-time interactions, focusing on meaningful engagement rather than constant notifications. Like the Slow Food Movement, it encourages a deeper connection with web content and services.
---

![rw-book-cover](https://jackcheng.com/assets/images/jack-and-matisse.jpg)
...
*The long version? Better discussed [one-on-one](mailto:hello@jackcheng.com), perhaps.*
...
iDoneThis is a part of the slow web movement. **The Slow Web Movement.** I’d never heard that phrase before. I immediately started digging around – and by that I mean I googled “Slow Web Movement” – and the lone relevant search result was [a blog post from two years ago.](http://www.rebeccablood.net/archive/2010/06/a_slow_web.html)If you run the search again today, you’ll find [Walter’s writeup](http://blog.idonethis.com/post/21267449208/the-slow-web-movement) on his company blog, which reflects a lot of what he told me over dinner.
...
That’s why most email productivity systems are concerned with a form of moderation: standardization. They encourage you to standardize the size and demandingness of the interaction (archive or delete messages and move on, transfer email requiring lengthy follow-ups to a to-do list, [limit responses to three sentences](http://three.sentenc.es/)) and standardizing the frequency (limit checking email to x times a day, at specified times).

A great example of rhythm and moderation in practice is the rollout of [Wander](http://onwander.com/). For the weeks leading up to their beta launch, [Keenan](http://keenancummings.com/) and crew took what could have been a first-run experience on another site and stretched it out over the course of four weeks into something akin to an advent calendar. Every week there is a similarly demanding interaction: give a place, pick a photo, type a reason.

Another service that does this well is [Budge](http://bud.ge/) from [Buster](http://busterbenson.com/) and the team at [Habit Labs](http://habitlabs.com/). Budge is built around notifications reminding you to do the daily things that improve your life in small but beneficial ways, like flossing, meditating, or tracking your weight. Once you’ve signed up, you can interact with Budge solely through their notifications. In the past I’ve gone for weeks without visiting their site or app while still happily using the service just by replying to the timed texts I get on my phone.
