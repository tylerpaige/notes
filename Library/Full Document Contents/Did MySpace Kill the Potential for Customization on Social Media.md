---
Author: Ernie Smith
Full Title: Did MySpace Kill the Potential for Customization on Social Media?
Category: #articles
Publication date: 2020-07-14
URL: https://tedium.co/2020/07/14/social-media-customization-failings/
Summary: The rise of social networks has led to the loss of design and customization freedom on these platforms. Unlike older platforms like Geocities and MySpace that encouraged digital creativity by providing a platform for user experimentation, newer networks prioritize behavioral development over design. This lack of flexibility and customization options has led users to seek other platforms like Substack. While some platforms like Tumblr still prioritize customization, others like Facebook emphasize standardization. The lack of design flexibility and customizability on modern platforms has deep roots and its structural weaknesses guarantee that it will falter once and for all.
---

![rw-book-cover](https://images.tedium.co/uploads/tedium071420.gif)

# Notes

[[Ernie Smith - Did MySpace Kill the Potential for Customization on Social Media?]]
...
[Substack](https://substack.com/) is an essential platform for many budding writers and journalists, and it comes with a built-in business model that respects writers and allows them to make money from their work. I respect what they do for my field.
...
*Think of building a custom design as the adult version of being able to draw with crayons when you were five, and you start to understand the problem to some degree. ([Kristin Brown/Unsplash](https://unsplash.com/photos/3kBtYrZ0-hw))*
...
Look, I get that [email design is a dark art](https://tedium.co/2019/06/25/html-email-limitations-design/), and that not everyone is naturally talented as a designer, but the result is that the creator’s identity is put to the side in favor of the organization’s.
...
But a combination of a quick departure and an unforced [technical error](https://tedium.co/2019/09/24/creativity-technical-errors-impact/) created an unexpected opportunity for a new social network. In the 2009 book [*Stealing MySpace*](https://amzn.to/2C2Ogdl), the story of the platform that made Tom everyone’s friend, author Julia Angwin (now of [The Markup](https://themarkup.org)) notes that the pivotal move that made MySpace relevant was twofold. One, the network essentially didn’t care about using real names, something its early competitor Friendster controversially did; and second, the company made a mistake in programming its website that opened up an entire world to its users.

Duc Chau, the original lead developer of MySpace, ended up leaving because he found the work boring—essentially his technical skill, [honed with an early advertising startup](https://labusinessjournal.com/news/2007/nov/19/internet-pioneers-went-their-own-way-then-reunited/), wasn’t being taxed by the site’s platform. Chau’s departure was a problem for MySpace’s owners, as they weren’t aware of the language he used, Perl.
...
It also caused massive problems down the line—[as WireDelta notes](https://wiredelta.com/the-epic-tale-myspace-technical-failure/), the site was not built to scale up for the hundreds of millions of users it would eventually have, leading to the site being reprogrammed onto another proprietary platform, Microsoft’s ASP.NET, in 2005. The happy accident that allowed MySpace to grow—the ability to modify pages—remained.

*The Samy worm broke MySpace and won Samy a million friend requests. ([Samy Kamkar](https://samy.pl/myspace/))*

This would prove a problem over time, though. That year, the weaknesses in MySpace’s infrastructure were exploited by a 19-year-old hacker [who used a cross-site scripting](https://www.vice.com/en_us/article/wnjwb4/the-myspace-worm-that-changed-the-internet-forever) (XSS) attack to gain a million friends through an aggressive worm. The weaknesses in the security code, the same ones that allowed for all those background images and weird fonts, let the Samy worm do a lot of damage, quick, and forced MySpace to boost its security in the process.

(Side note: An early Facebook employee, Chris Putnam, [used a similar worm](https://www.quora.com/How-did-Chris-Putnam-get-hired-at-Facebook) to make Facebook profiles look like MySpace profiles … which earned him a job with the company.)
...
Oneupweb, a Michigan digital marketing firm, bet big on MySpace back in the day, but came away from it with a bit of a sour feeling, [as reflected in a 2010 blog post about MySpace](https://www.oneupweb.com/blog/oneupweb-how-customization-killed-myspace/), right around the time most had moved to Facebook and Twitter for good. Author Tony Owen noted that he was fairly talented with the platform, but he felt that many others weren’t, and that degraded the platform as a whole:
...
**— David Karp,** the founder and former leader of Tumblr, explaining in a 2011 interview with *Richmond BizSense* [why the platform has such a strong focus on customization](https://richmondbizsense.com/2011/01/17/monday-qa-growth-is-their-theme/) and design—something that makes it an exception in today’s world of social media, even today. [While Tumblr has taken its share of arrows](https://tedium.co/2019/08/22/tumblr-social-revival/) over the years, it is to this day perhaps the only major social network where you can basically design every element and make it your own, generally using your own HTML and design. Even on mobile.
...
“The baggage was too much. Users had too many bad experiences,” [Percival recalled](https://www.theguardian.com/technology/2015/mar/06/myspace-what-went-wrong-sean-percival-spotify). “They would go on there and they’d get hit with spam. There’d be all this weird stuff. The baggage was really intense.”

Sean Parker, an early Facebook employee and Napster cofounder, noted that MySpace was not built around iteration, and the lack of improvement finally caught up with it eventually. In comments to Jimmy Fallon at a 2011 conference, [he had this to say](https://news.yahoo.com/sean-parker-myspace-could-facebook-114412792.html):
...
What it gained in exchange for that shift was an early foothold on something that matters a lot to modern advertisers: brand safety. Facebook, which is [in the midst of an advertiser boycott](https://www.cnet.com/news/facebook-ad-boycott-how-big-businesses-hit-pause-on-hate/), won over users by being seen as the “safe alternative” to MySpace, a site its own executives called “[a massive spaghetti-ball mess](https://www.theguardian.com/technology/2015/mar/06/myspace-what-went-wrong-sean-percival-spotify)” of code.

Facebook, [for all its problems](https://www.wired.com/story/inside-facebook-mark-zuckerberg-2-years-of-hell/) and punch-drunk illustrations in *Wired* over the years, [gained a reputation among users as a “safe space” compared to MySpace](https://www.forbes.com/sites/gilpress/2018/04/08/why-facebook-triumphed-over-all-other-social-networks/#22b4c4bc6e91), which eventually followed through to advertisers and has been hard to shake since.
...
But I think in many ways we’re paying for that decision all these years later. While not saying that MySpace was a drama-free zone—far from it; [remember ordering your top eight?](https://www.digitalspy.com/tech/a804288/things-youll-only-remember-if-you-were-addicted-to-myspace/)—I think the fact that most social networks not based around video don’t truly value creativity in the spirit of the original web has taken away from some of the internet’s original power.
...
Find this one an interesting read? [Share it with a pal!](https://tedium.co/2020/07/14/social-media-customization-failings/) And thanks to [*Sunday in the Heights With Dolly!*](https://www.sundayintheheightswithdolly.com) for sponsoring today’s issue. Be sure to give them a listen.
...
###### **More Attention Ploys**
 ...
 [###### Have we let the LED indicator light go too far? These lights are everywhere, and they make it hard to sleep. Here’s a case for some less-annoying indicators.](https://tedium.co/2020/07/10/led-indicator-light-history/) 

[Read more in the Archives](https://tedium.co/archive)
