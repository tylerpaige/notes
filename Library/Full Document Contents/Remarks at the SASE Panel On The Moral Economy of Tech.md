...
Full Title: Remarks at the SASE Panel On The Moral Economy of Tech
Category:
Publication date: 2016-06-26
URL: http://idlewords.com/talks/sase_panel.htm
Summary: Tech programmers often act with too much confidence, treating the world like a software problem they can control. Surveillance capitalism uses personal data to profit, harming privacy and giving too much power to companies and governments. We need humility, political accountability, and limits on data storage to protect society.
---

# Notes

[[idlewords.com - Remarks at the SASE Panel On The Moral Economy of Tech]]

***

[Kieran Healy](https://kieranhealy.org/) (whose [remarks are here](https://kieranhealy.org/blog/archives/2016/06/28/sase-panel-on-the-moral-economy-of-technology/)), [Stuart Russell](https://people.eecs.berkeley.edu/~russell/) and [AnnaLee Saxenian](http://www.ischool.berkeley.edu/people/faculty/annaleesaxenian).

We were each asked to speak for ten minutes, to an audience of social scientists.
...
Such fantasies of control come with a dark side. Witness the current anxieties about an artificial superintelligence, or Elon Musk's apparently sincere belief that we're [living in a simulation](http://www.theverge.com/2016/6/2/11837874/elon-musk-says-odds-living-in-simulation). For a computer programmer, that's the ultimate loss of control. Instead of writing the software, you *are* the software.
...
Many of you had to obtain a US visa to attend this conference. The customs service announced yesterday it wants to [start asking people for their social media profiles](http://www.theverge.com/2016/6/24/12026364/us-customs-border-patrol-online-account-twitter-facebook-instagram). Imagine trying to attend your next conference without a LinkedIn profile, and explaining to the American authorities why you are so suspiciously off the grid.
...
Or imagine what the British surveillance state, already [the worst in Europe](https://en.wikipedia.org/wiki/Mass_surveillance_in_the_United_Kingdom), is going to look like in two years, when it's no longer bound by the protections of European law, and economic crisis has driven the country further into xenophobia.
...
I think a workable compromise will be to allow all kinds of surveillance, but [limit what anyone is allowed to store or sell](http://idlewords.com/six_fixes.htm).
