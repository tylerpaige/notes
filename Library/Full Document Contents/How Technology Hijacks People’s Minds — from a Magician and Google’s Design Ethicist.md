...
Full Title: How Technology Hijacks People’s Minds — from a Magician and Google’s Design Ethicist
Category: #articles
Publication date: 2019-10-16
URL: https://medium.com/@tristanharris/how-technology-hijacks-peoples-minds-from-a-magician-and-google-s-design-ethicist-56d62ef5edf3#.6kirbklc7
Summary: Technology often manipulates our choices, giving us the illusion of free will while shaping our decisions. Apps use tactics like intermittent rewards and fear of missing out to keep us engaged and distracted. We need better design that helps us make informed choices and prioritize what truly matters in our lives.
---

![rw-book-cover](https://miro.medium.com/max/1200/1*jv-w56ymDBTwsiqx7YdIdQ.jpeg)
...
![](https://miro.medium.com/max/700/1*IG2MfhS05JjHryBHnXLXwA.png)That’s me performing sleight of hand magic at my mother’s birthday party
...
![](https://miro.medium.com/max/628/1*kW01thCZaWQyq0A08hSj5Q.png)
...
![](https://miro.medium.com/max/640/1*-h0aCLf8EH5OxCIdMXERgA.jpeg)How *empowering is this menu* of choices for the need, “I ran out of toothpaste”?
...
![](https://miro.medium.com/max/700/1*Ih_bIVQ12Ibu076252-bKA.png)Yelp subtly reframes the group’s need “where can we go to keep talking?” in terms of photos of cocktails served.
...
![](https://miro.medium.com/max/700/1*LsgYHAM-xhnkYGSkocOmew.png)All user interfaces are menus. What if your email client gave you *empowering choices of ways to respond, instead of “what message do you want to type back?” (Design by Tristan Harris)*
...
![](https://miro.medium.com/max/622/1*iDMEQ0vQrx2ep_Z4G-mY1w.png)A list of notifications when we wake up in the morning — how *empowering is this menu of choices when we wake up? Does it reflect what we care about? (from* [*Joe Edelman’s Empowering Design Talk*](https://vimeo.com/123488311)*)*
...
![](https://miro.medium.com/max/700/1*BNOfmUQ2nTRVPVe0CHx7ew.png)How often do you check your email per day?
...
Does this effect really work on people? Yes. **Slot machines make more money in the United States than baseball, movies, and theme parks** [**combined**](http://www.cbsnews.com/news/slot-machines-the-big-gamble-07-01-2011/)***.*** Relative to other kinds of gambling, people get ‘problematically involved’ with slot machines [**3–4x faster**](http://99percentinvisible.org/episode/episode-78-no-armed-bandit/) according to NYU professor Natasha Dow Schull, author of *Addiction by Design.*

![](https://miro.medium.com/max/700/1*jv-w56ymDBTwsiqx7YdIdQ.jpeg)Image courtesy of Jopwell
...
![](https://miro.medium.com/max/700/1*IoBUUcjfeAUnmY2ccu75Ww.png)
...
The thought, “what if I miss something important?” is generated *in advance of unplugging, unsubscribing, or turning off* — not after. Imagine if tech companies recognized that, and helped us proactively tune our relationships with friends and businesses in terms of what we define as “[time well spent](http://timewellspent.io)” for our lives, instead of in terms of what we might miss.

#### Hijack #4: Social Approval

![](https://miro.medium.com/max/638/1*qnyJGSiHouwhM_rhhvy_rA.png)Easily one of the most persuasive things a human being can receive.
...
![](https://miro.medium.com/max/276/1*YkxjEeZ_CO0a2Gp9Awf_bQ.png)Facebook uses automatic suggestions like this to get people to tag more people, creating more social externalities and interruptions.
...
![](https://miro.medium.com/max/700/1*7Gt5k-6sigW8e1QoLARuYg.png)
...
![](https://miro.medium.com/max/680/1*B5ZVhb7eL7hyEcfS8m1onQ.png)
...
![](https://miro.medium.com/max/614/1*GcrioynC_fnLRB4Vmu-X_g.png)After accepting an endorsement, LinkedIn takes advantage of your bias to reciprocate by offering \*four\* additional people for you to endorse in return.
...
![](https://miro.medium.com/max/700/1*5wyghDrGzpUYxGZkZRzE_A.png)
#### **Hijack #6: Bottomless bowls, Infinite Feeds, and Autoplay**

![](https://miro.medium.com/max/636/1*d_4O5k_1k9LLadu3HMmtXg.png)YouTube autoplays the next video after a countdown
...
![](https://miro.medium.com/max/700/1*y2lmMCXN6papGONxwGDazA.png)
![](https://miro.medium.com/max/700/1*l1rcapgZdtApL4rph3Sj3A.jpeg)Facebook autoplays the next video after a countdown
...
Instead, imagine if technology companies empowered you to *consciously bound your experience* to align with what would be “[time well spent](http://timewellspent.io)” for you. Not just bounding the *quantity* of time you spend, but the *qualities* of what would be “time well spent.”
...
*In other words, they make the thing customers want (milk, pharmacy) inseparable from what the business wants.* If stores were *truly organized to support people*, they would [put the most popular items in the front](http://www.economist.com/node/12792420).
...
![](https://miro.medium.com/max/680/1*kSGi-JcMMGgwigs6VgFY2A.png)NYTimes claims it’s giving a free choice to cancel your account
...
![](https://miro.medium.com/max/700/1*vQ7yG7niPETreL7zjBuFkA.png)Facebook promises an easy choice to “See Photo.” Would we still click if it gave the true price tag?
...
![](https://miro.medium.com/max/651/1*Xvo46OL3h2wDdb7S7AA1uQ.png)TripAdvisor uses a “foot in the door” technique by asking for a single click review (“How many stars?”) while hiding the three page survey of questions behind the click.
...
*Tristan Harris was a Design Ethicist at Google until 2016 where he studied how technology restructures two billion people’s attention, wellbeing and behavior. For more resources on Time Well Spent and the Center for Humane Technology, see* [*http://humanetech.com*](http://humanetech.com)*.*
