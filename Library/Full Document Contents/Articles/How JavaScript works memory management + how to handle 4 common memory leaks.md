...
![rw-book-cover](https://miro.medium.com/v2/da:true/resize:fit:972/1*WVtok3BV0NgU95mpxk9CNg.gif)

## Metadata
- Author: [[Alexander Zlatkov]]
- Full Title: How JavaScript works: memory management + how to handle 4 common memory leaks
- Category: #articles
- Publication date: 2023-04-27
- URL: https://blog.sessionstack.com/how-javascript-works-memory-management-how-to-handle-4-common-memory-leaks-3f28b94cfbec
- Summary: JavaScript allocates memory and uses a garbage collector to free it automatically.  
But garbage collection cannot always tell when data is truly no longer needed.  
Lingering references from closures, timers, or globals can keep big objects alive and cause memory spikes.

# Notes

[[Alexander Zlatkov - How JavaScript works: memory management + how to handle 4 common memory leaks]]
...
![](https://miro.medium.com/v2/resize:fit:700/1*slxXgq_TO38TgtoKpWa_jQ.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*5aBou4onl1B8xlgwoGTDOg.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*qY-yRQWGI-DLS3zRHYHm9A.png)Differences between statically and dynamically allocated memory
...
![](https://miro.medium.com/v2/resize:fit:386/1*GF3p99CQPZkX3UkgyVKSHw.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*WVtok3BV0NgU95mpxk9CNg.gif)A visualization of the mark and sweep algorithm in action
...
![](https://miro.medium.com/v2/resize:fit:700/1*FbbOG9mcqWZtNajjDO6SaA.png)
...
![](https://miro.medium.com/v2/resize:fit:450/1*0B-dAUOH7NrcCDP6GhKHQw.jpeg)
...
element.parentNode.removeChild(element);// Now when element goes out of scope,  
...
With SessionStack, you [replay issues](https://www.sessionstack.com/blog/product-usage-analytics-the-product-managers-guide-to-uncovering-hidden-usability-issues/) in your web apps as videos and see everything that happened to your user. And all of this has to take place with no performance impact for your web app.  
...
There is a free plan so you can [give it a try now](https://www.sessionstack.com/solutions/developers/?utm_source=medium&utm_medium=blog&utm_content=memory-management).

![](https://miro.medium.com/v2/1*kEQmoMuNBDfZKNSBh0tvRA.png)
#### Resources
