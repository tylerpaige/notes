...
[[Quinn Norton - Anonymous 101: Introduction to the Lulz]]
...
![Image may contain Human Person Clothing Apparel Pants Shoe Footwear Pedestrian Car Transportation and Vehicle](https://media.wired.com/photos/59327804edfced5820d10bfa/master/w_2560%2Cc_limit/anon-scientology-f.jpg)Anonymous has kept up its monthly protest, including this one from November 13, 2011, outside the Church of Scientology headquarters in downtown San Francisco.
...
Last week the net and the media were ablaze with the news that [Anonymous might be taking on the Zeta drug cartel](https://www.wired.com/threatlevel/2011/10/opcartel/) in Mexico, a story that has [morphed into a wider drug corruption story](http://idealab.talkingpointsmemo.com/2011/11/whatever-happened-to-anonymous-operation-cartel.php?ref=fpb), and led to [one American law enforcement official in North Carolina](http://mountainx.com/article/37219/Xpress-investigating-e-mails-containing-allegations-about-Ron-Moore) being named as a gang conspirator.

Also this year, Anons released documents on, or d0xed, [several police organizations and one prominent police vendor](https://www.wired.com/threatlevel/2011/10/anonymous-law-enforcement/) in retaliation for heavy-handed law enforcement reaction to occupations associated with the Occupy Wall Street movement. They've fought with [child pornographers](http://forums.whyweprotest.net/threads/anonymous-operation-darknet-war-on-pedophilia.95031/), hacked Sony repeatedly, and even tried to release compromising pictures to [blackmail Bay Area Rapid Transit spokesman Linton Johnson into resigning](http://blogs.sfweekly.com/thesnitch/2011/08/anonymous_naked_linton_johnson.php). (Johnson claimed to have authored and then defended BART's controversial decision to shut off mobile phone service in BART stations to pre-empt an anti-police brutality protest.)
...
[![](https://www.wired.com/images_blogs/threatlevel/2011/11/thelulz-300x240.png)](https://www.wired.com/threatlevel/2011/11/anonymous-101/thelulz/)
...
Like [Alan Moore's character V](http://en.wikipedia.org/wiki/V_(comics)) who inspired Anonymous to adopt the Guy Fawkes mask as an icon and fashion item, you're never quite sure if Anonymous is the hero or antihero. The trickster is attracted to change and the need for change, and that's where Anonymous goes. But they are not your personal army - that's Rule 44 - yes, [there are rules](http://knowyourmeme.com/memes/rules-of-the-internet#.Trhw3PSXuso). And when they do something, it never goes quite as planned. The internet has no neat endings.
...
![](https://media.wired.com/photos/5932780544db296121d6b5b0/master/w_1600%2Cc_limit/dangerous.jpg)
But to be historical, let's start with 4chan.org, a wildly popular board for sharing images and talking about them, and in particular, 4chan's [/b/ board](http://boards.4chan.org/b/) (Really, really, NSFW). /b/ is a web forum where posts have no author names and there are no archives and it's explicitly about anything at all. This technological format meeting with the internet in the early 21st Century gave birth to Anonymous, and it remains the mother's teat from which Anonymous sucks. (Rule 22)
...
That's what you'll find in /b/, the unspoken. '/b/tards', as denizens of the board are called and call themselves, create incest porn, fantasize about beating women, look for [dataviz](http://en.wikipedia.org/wiki/Data_visualization) examples or coding tips. They are grown men that really want to talk about "My Little Pony: Friendship is Magic." Maybe it's ironic, maybe it's not. (I'm told by one such [brony](http://www.urbandictionary.com/define.php?term=Brony) that the show is just a lot better than you'd expect.)

At some moment lost in its unrecorded history, /b/ and Anonymous reached an inflection point, and the id spilled into the rest of the net in the form of "[ultra-coordinated motherfuckery](http://www.rennygleeson.com/2011/02/07/hacker-collectives/ultramotherfuckery-2/)," as one anon described it to Coleman. This was the ability to use the technological tools of social coordination so quickly and well that anons working together could collectively attack targets for any perceived slight, or just for fun, without those targets ever having a chance to see it coming or defend themselves.

These came to be called "raids."

Over time raids took many forms, eventually moving into the regular world. They could look like protests, massively coordinated pranks, distributed-denial-of-service attacks (DDOS) or straight-up hacking attacks. D0xing, ordering unpaid pizzas, signing people up for embarrassing junk mail were all common raids. There's a [raid that you know for sure](http://www.youtube.com/watch?v=oHg5SJYRHA0). It's likely you've even participated, and even more likely you've been a victim of it; the rickroll. The [rickroll](http://en.wikipedia.org/wiki/Rickrolling) began as a tool of the /b/tard/Anonymous raid, before spreading so far into the culture that the [Oregon legislature](http://www.youtube.com/watch?v=fZi4JxbTwPo) and even the [US Speaker of the House](http://www.youtube.com/watch?v=wtOW1CxHvNY) were rickrolling the world.
...
But the video contained some truly epic lulz, and Anonymous wouldn't let it die. The church's effort to kill it off so [enraged Anons they decided to destroy the church itself.](https://www.wired.com/culture/culturereviews/magazine/17-10/mf_chanology?currentPage=all) By enraged, I mean a pissy kind of laughing and spitting at once. For Anonymous being mad meant wanting to [troll](http://en.wikipedia.org/wiki/Troll_(Internet)) the church very hard, but it was never to get serious, because getting serious for Anons meant losing.
...
There's no proof that the people that started Project Chanology had any personal beefs against the Church of Scientology beyond their secondhand annoyance at the Church's litigious history and attempted suppression of speech. But probably most importantly, the Church was rampantly guilty of [feeding the trolls](http://www.urbandictionary.com/define.php?term=feeding%20the%20trolls). (Rule 14)
...
And yes, they brought [Long Cat](http://knowyourmeme.com/memes/longcat#.Trh1DvSXuso).

[![](https://www.wired.com/images_blogs/threatlevel/2011/11/ohfuck.jpg)](https://www.wired.com/threatlevel/2011/11/anonymous-101/ohfuck-2/)
*Coming soon: Part Two: Three Years of Epic Trolling the Church of Scientology, the LOIC, and OpPayback*

*This post is part of a special series from Quinn Norton, who is embedding with Occupy protestors and going beyond the headlines with Anonymous for Wired.com. For an introduction to the series, read Quinn's [description of the project](https://www.wired.com/threatlevel/2011/10/quinn-norton-occupy/).*
