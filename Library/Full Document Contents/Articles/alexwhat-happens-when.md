...
![rw-book-cover](https://opengraph.githubassets.com/24557ae64c3b8d40c6ded04df5804529b6619c870b9e177ede596dd69e761339/alex/what-happens-when)

## Metadata
- Author: [[https://github.com/alex/]]
- Full Title: alex/what-happens-when
- Category: #articles
- URL: https://github.com/alex/what-happens-when
- Summary: The GitHub project "what-happens-when" explains the steps that occur when you type a URL, like google.com, in a browser and press enter. It details the processes of keyboard input, DNS lookup, HTTP requests, and how the browser renders the webpage. The goal is to provide a clear understanding of the complex actions behind a simple web request.

# Notes

[[https://github.com/alex/ - alex/what-happens-when]]
...
Read this in [简体中文](https://github.com/skyline75489/what-happens-when-zh_CN) (simplified Chinese), [日本語](https://github.com/tettttsuo/what-happens-when-JA) (Japanese), [한국어](https://github.com/SantonyChoi/what-happens-when-KR) (Korean) and [Spanish](https://github.com/gonzaleztroyano/what-happens-when-ES). NOTE: these have not been reviewed by the alex/what-happens-when maintainers.

#### Table of Contents

* [The "g" key is pressed](https://github.com/alex/what-happens-when#the-g-key-is-pressed)
* [The "enter" key bottoms out](https://github.com/alex/what-happens-when#the-enter-key-bottoms-out)
* [Interrupt fires [NOT for USB keyboards]](https://github.com/alex/what-happens-when#interrupt-fires-not-for-usb-keyboards)
* [(On Windows) A `WM_KEYDOWN` message is sent to the app](https://github.com/alex/what-happens-when#on-windows-a-wm-keydown-message-is-sent-to-the-app)
* [(On OS X) A `KeyDown` NSEvent is sent to the app](https://github.com/alex/what-happens-when#on-os-x-a-keydown-nsevent-is-sent-to-the-app)
* [(On GNU/Linux) the Xorg server listens for keycodes](https://github.com/alex/what-happens-when#on-gnu-linux-the-xorg-server-listens-for-keycodes)
* [Parse URL](https://github.com/alex/what-happens-when#parse-url)
* [Is it a URL or a search term?](https://github.com/alex/what-happens-when#is-it-a-url-or-a-search-term)
* [Convert non-ASCII Unicode characters in the hostname](https://github.com/alex/what-happens-when#convert-non-ascii-unicode-characters-in-the-hostname)
* [Check HSTS list](https://github.com/alex/what-happens-when#check-hsts-list)
* [DNS lookup](https://github.com/alex/what-happens-when#dns-lookup)
* [ARP process](https://github.com/alex/what-happens-when#arp-process)
* [Opening of a socket](https://github.com/alex/what-happens-when#opening-of-a-socket)
* [TLS handshake](https://github.com/alex/what-happens-when#tls-handshake)
* [If a packet is dropped](https://github.com/alex/what-happens-when#if-a-packet-is-dropped)
* [HTTP protocol](https://github.com/alex/what-happens-when#http-protocol)
* [HTTP Server Request Handle](https://github.com/alex/what-happens-when#http-server-request-handle)
* [Behind the scenes of the Browser](https://github.com/alex/what-happens-when#behind-the-scenes-of-the-browser)
* [Browser](https://github.com/alex/what-happens-when#browser)
* [HTML parsing](https://github.com/alex/what-happens-when#html-parsing)
* [CSS interpretation](https://github.com/alex/what-happens-when#css-interpretation)
* [Page Rendering](https://github.com/alex/what-happens-when#page-rendering)
* [GPU Rendering](https://github.com/alex/what-happens-when#gpu-rendering)
* [Window Server](https://github.com/alex/what-happens-when#window-server)
* [Post-rendering and user-induced execution](https://github.com/alex/what-happens-when#post-rendering-and-user-induced-execution)
