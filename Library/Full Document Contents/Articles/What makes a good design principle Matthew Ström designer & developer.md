...
- Full Title: What makes a good design principle? || Matthew Ström: designer & developer
- Category: #articles
- Publication date: 2017-11-14
- URL: https://matthewstrom.com/writing/principles
- Summary: When creating good design principles, they should be memorable, help you say no, not be truisms, and be applicable. A useful tool for this that can be used is Even Over statements - formatted as (Choice A) even over (Choice B).

# Notes

[[Matthew Ström - What makes a good design principle? || Matthew Ström: designer & developer]]
...
A good test of truism is the **reversibility test.**[1](https://matthewstrom.com/writing/principles/#fn1) A principle passes the test if the opposite of that principle is something a reasonable person might believe.
...
Some years ago, I was introduced to the [Even Over](http://futureofwork.nobl.io/future-of-work/how-to-distill-a-strategy-into-simple-rules-of-thumb-for-busy-teams) statement by some close friends and collaborators[2](https://matthewstrom.com/writing/principles/#fn2). Even Over statements are constructed as follows:
