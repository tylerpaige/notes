...
## Metadata
- Author: [[Dan Abramov]]
- Full Title: You Might Not Need Redux – Dan Abramov – Medium
- Category: #articles
- Publication date: 2016-09-19
- URL: https://medium.com/@dan_abramov/you-might-not-need-redux-be46360cf367
- Summary: The text discusses how some developers may adopt Redux prematurely, leading to unnecessary complexity in their code. It highlights that while Redux offers benefits like state persistence and debugging capabilities, it is not always essential and should be approached with caution. The author suggests that developers should focus on understanding React first and only introduce Redux when a genuine need arises, emphasizing the importance of thoughtful consideration when adopting new tools.

# Notes

[[Dan Abramov - You Might Not Need Redux – Dan Abramov – Medium]]
...
Some content could not be imported from the original document. [View content ↗](https://medium.com/@dan_abramov/you-might-not-need-redux-be46360cf367) 
