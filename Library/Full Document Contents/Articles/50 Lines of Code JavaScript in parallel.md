# 50 Lines of Code: JavaScript in parallel

![rw-book-cover](https://50linesofco.de/favicon.png)

## Metadata
- Author: [[50linesofco.de]]
- Full Title: 50 Lines of Code: JavaScript in parallel
- Category: #articles
- URL: http://50linesofco.de/post/2017-02-06-javascript-in-parallel-web-workers-transferables-and-sharedarraybuffer
- Summary: http://50linesofco.de/post/2017-02-06-javascript-in-parallel-web-workers-transferables-and-sharedarraybuffer

# Notes

[[50linesofco.de - 50 Lines of Code: JavaScript in parallel]]

***

### Workers, transferable objects and SharedArrayBuffer

![](https://50linesofco.de/images/post-images/parallelism/DividingTimeline4x.png)
#### TL;DR
...
![](https://readwise.io/reader/imgproxy?url=http%3A//50linesofco.de/images/post-images/parallelism/MainThread.jpg&hash=daf29da9470a823a4427ff687a93347e)
...
![](https://readwise.io/reader/imgproxy?url=http%3A//50linesofco.de/images/post-images/parallelism/SimpleWorker.jpg&hash=d9d4e5d2ed23d4ce8085cc29921ecd7b)
...
![](https://readwise.io/reader/imgproxy?url=http%3A//50linesofco.de/images/post-images/parallelism/TransferringTiming.jpg&hash=6103ddf40f592359698bf3f390649632)
...
![](https://readwise.io/reader/imgproxy?url=http%3A//50linesofco.de/images/post-images/parallelism/DividingWorkersTiming.jpg&hash=8f59d31d29051a725dafefc491e48c4e)
...
![](https://readwise.io/reader/imgproxy?url=http%3A//50linesofco.de/images/post-images/parallelism/DividingWorkers8x.jpg&hash=0554d9388bc67282a49fcac7c793af75)Well, this got slower! The timeline shows us why this happened:
...
![](https://readwise.io/reader/imgproxy?url=http%3A//50linesofco.de/images/post-images/parallelism/SharingBuffer.jpg&hash=e4931cff4e414b1334d6e5564d685ac7)
