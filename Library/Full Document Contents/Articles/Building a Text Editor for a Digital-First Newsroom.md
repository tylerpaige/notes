...
![rw-book-cover](https://miro.medium.com/v2/da:true/resize:fit:1004/1*LnJwoZLOuEZ1v1eAN-UWZg.gif)

## Metadata
- Author: [[Sophia Ciocca]]
- Full Title: Building a Text Editor for a Digital-First Newsroom
- Category: #articles
- Publication date: 2018-04-26
- URL: https://open.nytimes.com/building-a-text-editor-for-a-digital-first-newsroom-f1cb8367fc21
- Summary: Building a text editor for a digital-first newsroom involves creating a customized story editor that combines the features of Google Docs and Medium while addressing the specific workflow needs of the newsroom. The New York Times developed a new text editor called Oak, built on the foundation of ProseMirror, an open-source JavaScript toolkit. ProseMirror represents the document using its own data structure, allowing for easy rendering in different formats. The editor uses nodes and marks to structure and style the text, and tracks changes through a step-based system. Oak includes features such as track changes, custom headers, and comments to enhance the newsroom workflow.

# Notes

[[Sophia Ciocca - Building a Text Editor for a Digital-First Newsroom]]

***

#### An inside look at the inner workings of a technology you may take for granted

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*LnJwoZLOuEZ1v1eAN-UWZg.gif)Illustration by Aaron Krolik/The New York Times
...
![](https://miro.medium.com/v2/resize:fit:2000/format:webp/1*Ek78_oxd_hD-fn_dx-YvFg.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/0*oGZfDS1Rlm4MzAQu.)Traditional DOM representation of a sentence — its tags work in a nested, tree-like fashion. Source:
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/0*BKjocnJ6-DyNj-tK.)How ProseMirror would structure the same sentence. Source: ProseMirror
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*tSuAfd7GowO1oQoLRPQt5A.gif)Our version comparison feature relies on keeping careful track of each transaction in an immutable Redux state.
...
![](https://miro.medium.com/v2/resize:fit:1100/format:webp/1*_cgjmva3RSguksfzzMsfhA.png)A few of Oak’s header options. From left to right: Basic header, Horizontal full-bleed header, Vertical full-bleed header. 
![](https://miro.medium.com/v2/resize:fit:1100/format:webp/1*tQYcbXpRjU4zkUwgSurr8Q.png)A few of Oak’s header options. From left to right: Basic header, Horizontal full-bleed header, Vertical full-bleed header. 
![](https://miro.medium.com/v2/resize:fit:1100/format:webp/1*gcFYFMW2K07mmG_q488f1Q.png)A few of Oak’s header options. From left to right: Basic header, Horizontal full-bleed header, Vertical full-bleed header. 
#### Comments
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*4t-fGEwAmWDBdhHjTVoswA.gif)In Oak, comments are a type of mark, but they’re displayed on the right side of the relevant text or node.
