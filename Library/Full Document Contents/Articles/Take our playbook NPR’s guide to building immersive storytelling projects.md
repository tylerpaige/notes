...
![rw-book-cover](https://training.npr.org/wp-content/uploads/2018/06/HDD-full-1024x539.jpg)

## Metadata
- Author: [[Wesley Lindamood]]
- Full Title: Take our playbook: NPR’s guide to building immersive storytelling projects
- Category: #articles
- Publication date: 2018-06-25
- URL: http://training.npr.org/digital/take-our-playbook-nprs-guide-to-building-immersive-storytelling-projects/
- Summary: NPR's guide introduces the Hypothesis-Driven Design (HDD) process to help teams create immersive storytelling projects. This approach involves researching, planning, prototyping, developing, launching, and reviewing stories through collaboration and experimentation. The guide aims to enhance storytelling by using a structured method that encourages innovation and audience engagement.

# Notes

[[Wesley Lindamood - Take our playbook: NPR’s guide to building immersive storytelling projects]]

***

![](https://training.npr.org/wp-content/uploads/2018/06/HDD-full.jpg)The Hypothesis-Driven Design process can help your team figure out how all the pieces fit together in a complex storytelling project. (Deborah Lee/NPR)
...
And yet, it’s possible to apply a repeatable formula to make format-breaking stories. At NPR, we have used an editorial development process called Hypothesis-Driven Design (or HDD for short) on many successful projects. It is inspired by similar processes in product development, like [Lean UX](https://www.smashingmagazine.com/2011/03/lean-ux-getting-out-of-the-deliverables-business/), that emphasize lightweight testing and prototyping to validate ideas. We’ve used aspects of HDD to create everything from live fact checks of presidential debates to a virtual reality experience in the Rocky Mountains.

This post provides an introduction to Hypothesis-Driven Design, as well as our [step-by-step guide](http://n.pr/hdd) for taking projects from concept to completion. The guide, which you can view in Google Docs at [n.pr/hdd](http://n.pr/hdd) or [download as a PDF](http://n.pr/hdd-pdf), is geared toward folks with experience leading digital storytelling projects and includes recommended roles and responsibilities on an HDD team as well as templates for each step to help you get started.

##### **Applying the scientific method to storytelling**

![title cards](https://training.npr.org/wp-content/uploads/2018/06/title-cards-look.jpg)
The title card of the story What Does Music Look Like? includes a headline and subhead. For the story Rain Forest Was Here (right), we hypothesized that introducing the story with a sentence would lead more users to continue through it. (Wes Lindamood/NPR)
...
Wireframes and a mockup in the prototype stage followed by an animated sequence from the final project show the evolution of the story design for the project Stand At The Edge Of Geologic Time. (Wes Lindamood/NPR)

When working on a story about [the aftermath of Ebola in Liberia](http://apps.npr.org/life-after-death/), we wanted to tell the story in a direct, close-up way. Liberia had been the subject of extensive media attention during the peak of the outbreak, and public interest in the topic was waning, so we knew we needed to do something distinctive to help the story stand out. We believed the story would be more successful if the audience could hear directly from survivors in an immersive way, and we used HDD to explore approaches that supported this goal.

When working on [fact checks and analysis during the 2016 Election](https://www.npr.org/2016/09/26/495115346/fact-check-first-presidential-debate), we wanted to improve upon how we had done fact checks in the past and create a real-time platform that would not be possible in a standard article template. We believed that by providing live annotations in the context of a full transcript we would build audience trust in our analysis, and showcase the expertise of our newsroom in an engaging way.

And when [exploring the potential for 360-degree audio in virtual reality](http://apps.npr.org/rockymountain-vr/), we believed it was important to explore multiple modes of experience and make the story accessible to VR and non-VR audiences.

##### **The Hypothesis-Driven Design process, at a glance**

![hypothesis-driven design diagram](https://training.npr.org/wp-content/uploads/2018/06/hdd-diagram.png)
To give you a better feel for [what’s in the HDD guide](http://n.pr/hdd), here’s a bird’s eye view of its six stages: Research, Plan, Prototype, Develop, Launch and Review.
...
![collaboration](https://training.npr.org/wp-content/uploads/2018/06/collaboration.jpg)
From left, Team members Wes Lindamood, Kainaz Amaria, Claire O’Neill, and Alyson Hurt discuss the structure of the project Planet Money Makes A T-Shirt. HDD projects are collaborative and cross-disciplinary. Group edits, sketching session and daily face-to-face meetings are common practice for the process. (Brian Boyer)
...
You can think of this as the story pitch stage, where a reporter comes to an editor with an idea. The editor is there to help the reporter figure out the shape of the story. If it’s a [topic without a story](https://training.npr.org/audio/what-makes-a-good-pitch-npr-editors-weigh-in/), the editor is going to ask the reporter to go back and find a story. Like in our reporting, we want to be strategic about the digital projects we work on. Before starting a project, we should be able to clearly explain the editorial value of the project and how it will serve our audience.
...
Team sketches from a sketching session exploring the Fence Facts section of the NPR story Borderland. To make the sketching session accessible to remote participants, the team used screen sharing via Google Hangouts to share drawings (Wes Lindamood/NPR)
...
Ready to learn more? View the guide online at [n.pr/hdd](http://n.pr/hdd) or [download the guide](http://n.pr/hdd-pdf) and let us know what you think. Trying something similar in your newsroom? What’s worked and what hasn’t? We’d love feedback. You can find us on Twitter at [@nprtraining](https://twitter.com/nprtraining).

Wesley Lindamood was a senior interaction designer on the NPR’s Digital Content team.
