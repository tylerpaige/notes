...
![rw-book-cover](https://miro.medium.com/max/1200/1*MoyNNBnjxS88SJ7W2SDK0g.png)

## Metadata
- Author: [[kennedy elliott]]
- Full Title: 39 studies about human perception in 30 minutes – Medium
- Category: #articles
- Publication date: 2019-10-22
- URL: https://medium.com/@kennelliott/39-studies-about-human-perception-in-30-minutes-4728f9e31a73#.d9kpflvfz
- Summary: The article discusses research on how humans perceive different types of data graphics, highlighting biases and preferences for pie charts over bar charts for conveying proportions. It also notes that people tend to focus on trends in line charts and contrasts in bar charts, affecting their interpretation. Lastly, the findings suggest that 3D graphics can be misleading, while simpler visualizations often enhance understanding.

# Notes

[[kennedy elliott - 39 studies about human perception in 30 minutes – Medium]]

***

![](https://miro.medium.com/max/700/1*MoyNNBnjxS88SJ7W2SDK0g.png)
...
![](https://miro.medium.com/max/700/1*2wyuUVD9hsn_ofEXjlDlGg.jpeg)In several experiments, Cleveland and McGill identified “elementary perceptual tasks”: the most basic tasks they believe viewers perform when evaluating a visualization.
...
![](https://miro.medium.com/max/500/1*AAzS3xp6l7s3pp8eosdJKg.jpeg)Heer and Bostock’s experiments with Mechanical Turk participants yielded similar results to those of Cleveland and McGill.
...
![](https://miro.medium.com/max/700/1*sWyILOFlzdacK0T6zv0POQ.png)Jordan and Schiano found that when lines of varying sizes were presented close together, participants recalled them being more similar in length. When they were presented farther apart, participants saw larger contrasts between the lines.
...
![](https://miro.medium.com/max/350/1*XA2CQkBZJHp8tGf9hZEIuw.png)In two separate studies, Schiano and Tversky found that the 45-degree line is an imaginary reference point in line graphs, but not in other types of charts.
...
![](https://miro.medium.com/max/600/1*fP0w8rOrSOa8rdjorKkZew.png)Croxton found that participants were more accurate when they compared the sizes of bars of unequal lengths. Squares and circles were not much different. All three shapes fared better than cubes.
...
![](https://miro.medium.com/max/700/1*6WpAPX8d0kXNb_X_qj2xcw.png)Eells gave a psychology class two worksheets — a series of pie charts and bar charts — and asked them to estimate the proportion of each segment to the whole.
...
![](https://miro.medium.com/max/670/1*fAG4HYTXPeaiywsHQHo24w.png)The three ways participants in Eells’s study reported perceiving proportion in pie charts. Only one woman reported using chords, most likely because she had special training for this. She was the most accurate person in the class in perceiving proportion in pie charts.
...
![](https://miro.medium.com/max/700/1*mGj-s-ERK51RtLKov6L95w.jpeg)Eells’s absurd, sexist conclusion from his study.
...
![](https://miro.medium.com/max/564/1*8ZmhHo3eM3DPZG4-kccHwg.png)Simkin and Hastie concluded that individuals have a particular schema for what to expect when viewing a particular chart.
...
![](https://miro.medium.com/max/700/1*KhoM1XM0yZTr-ap3mnY4Fw.png)Zacks and Tversky found that participants described contrasts between the x-axis variables more when presented with bar charts, and relationships between the x-axis variables more with line charts.
...
![](https://miro.medium.com/max/624/1*1uUkn5MffiFnK44AGufIBg.png)In their first experiment in the study, Hollands and Spence presented participants with these three graphs to evaluate how accurately they could evaluate change.
...
![](https://miro.medium.com/max/700/1*fy7Io6-qXQ60lAaTUtVhpQ.jpeg)Hollands and Spence guessed that the reason bar charts performed as well as line charts is because participants drew an imaginary line between the bars to detect change.
...
![](https://miro.medium.com/max/700/1*XuIjc7dI1oAZPsYlF77wgw.jpeg)Following common convention, altitude should be plotted on the x-axis because it is the independent variable in this case. However, plotting altitude on the y-axis allows for the slope of the line to become a visual metaphor for height.
...
![](https://miro.medium.com/max/700/1*vK2H6iby5cBDTyhqtUXQuQ.jpeg)Siegrist observed how well participants could evaluate size differences among 2d and 3d variants of pie and bar charts. Participants were about as accurate with 3d bar charts as the 2d versions, but were less successful with 3d pie charts.
...
![](https://miro.medium.com/max/700/1*P6DmkcfbLdmBIeahXsOE8Q.jpeg)In two separate experiments in the same study, Levy and coauthors gave participants several 2d and 3d chart options to choose from.
...
![](https://miro.medium.com/max/400/1*yAqIGa8ka0haY7Ntlk-qFw.jpeg)Spence found that humans perceive the distortion described in Steven’s law only if two or more dimensions were altered between shapes. If only one dimension is altered between shapes, distortion does not occur.
...
![](https://miro.medium.com/max/700/1*KKaBIrLzvliNBxJiJW-74g.png)Cleveland and coauthors found that altering point cloud size alone could lead to inaccuracies in evaluating correlation in scatterplots.
...
![](https://miro.medium.com/max/453/1*vJppRhmlheL_NmxgG0MO3g.png)Lewandowsky and Spence found that humans can most accurately discern variations in color in scatterplot symbols.
...
![](https://miro.medium.com/max/600/1*j09BYxRAyszJjlddi4nYmw.jpeg)Demiralp and coauthors reordered the existing Tableau color and symbol palette so that they were ranked by how easily individuals could perceive their differences.
...
![](https://miro.medium.com/max/700/1*40vE8sDqaKJhqX4RhwqBmg.png)Ziemkiewicz and Kosara used visual metaphors to direct participants to complete simple tasks with different types of treemaps. When the visual metaphors matched the particular style of the treemap, participants were more accurate.
...
![](https://miro.medium.com/max/700/1*0DQuyJkTw2dXqMmIkC-t2g.jpeg)Kong, Heer and Argawala’s experiments revealed that humans aren’t as accurate comparing the sizes of squares as comparing rectangles with varying aspect ratios.
...
![](https://miro.medium.com/max/700/1*V8WWX8vkJ3eKxJzokdq1Pg.jpeg)Participants were more accurate in making leaf-to-leaf comparisons in small multiples bar charts than treemaps.
...
![](https://miro.medium.com/max/492/1*gle0whV4_KrSGxWe4g3bUA.png)In Barlow and Neville’s 2001 study, participants did not care for the the treemap visualization.
...
![](https://miro.medium.com/max/400/1*YF6onzaze75iHEpOpQygpQ.png)In Cawthon and Moere’s 2007 study, participants favored the sunburst visualization.
...
![](https://miro.medium.com/max/590/1*ibLDWtxjTQP2JqouFIfh0g.png)Harrison and coauthors found that participants could most easily evaluate correlation in scatterplots (for both negative and positive correlations) and parallel coordinate plots (only for negative correlations).
...
![](https://miro.medium.com/max/700/1*0yvjbRJLBj6O-j9ij9yk1w.jpeg)Heer, Hong and Argrawala’s experiments involved time series charts that were reduced to a quarter of their original size.
![](https://miro.medium.com/max/700/1*zabSDcXpb5teUMS0eGcN-Q.jpeg)Researchers decreased chart height to test how effectively banding and mirroring could be perceived.
...
![](https://miro.medium.com/max/700/1*u741SzpN8HRi3xolxRxuNA.png)Haroz, Kosara and Franconeri found that replacing generic stacked shapes with stacked pictographs did not result in a decrease in accuracy for participants.
...
![](https://miro.medium.com/max/700/1*Y9MFCx3t_rgcbIxtB9YtdQ.jpeg)Cole and coauthors asked Mechanical Turk participants to interpret various shapes drawn by either a computer algorithm or a human artist.
...
![](https://miro.medium.com/max/700/1*y97FJXLPidFdx8Re0cB2Dw.png)Ziemkiewicz and coauthors tested participants on tasks that involved hierarchical plots that looked either list-like or container-like.
...
![](https://miro.medium.com/max/700/1*LwOO19q7O8RYYOruuNt_kg.jpeg)Lee and coauthors gave novice participants visualizations that they were not familiar with, and tested their performance with a particular graph type.
...
![](https://miro.medium.com/max/700/1*ayIgpmbk73CiYYeE-XjVBg.jpeg)Harrison and coauthors gave participants an article aimed at affecting their emotion and evaluated their performance in completing basic tasks with charts.
...
![](https://miro.medium.com/max/700/1*yNKoCTFjsS27dTrbLtRidg.png)Liu and Heer told participants to interact with two different visualizations with millions of data points each and observed how a delay of 500 milliseconds affected their interactions.
...
![](https://miro.medium.com/max/700/1*QACaH7g9pMinZKo3j1bw6A.png)Robertson and coauthors evaluated performance across three different types of visualizations showing the same data: an animated version, a traced version and a small multiples version.
...
![](https://miro.medium.com/max/500/1*prrmNpf8z2EvLxWxq0TdiQ.jpeg)In the first experiment of the study, Lin and coauthors tested how well their algorithm assigned colors to particular keywords by comparing their results to assignments made by Mechanical Turk participants.
...
![](https://miro.medium.com/max/500/1*xCkZ3Xtno0roaG0Oqew6aw.jpeg)In the second experiment, researchers evaluated how well participants performed in simple comparison tasks across three different color palettes. Above are the color assignments made by the algorithm and the human expert.
...
![](https://miro.medium.com/max/165/1*mVgjEX5MZzo8ot1s0raPfA.png)
