...
![rw-book-cover](https://bitsofco.de/assets/icons/icon_128.png?v=d8ab3c1484)

## Metadata
- Author: [[bitsofcode]]
- Full Title: Optimising GIFs for the Web
- Category: #articles
- Publication date: 2017-02-14
- URL: https://bitsofco.de/optimising-gifs/
- Summary: Like a lot of people, I like GIFs. I like to use them in my articles to illustrate functionality. For example, this GIF from my article on &quot;Recreating the iTunes Library&quot; -    However, a problem with this is that GIFs are heavy, the one above is a whopping

# Notes

[[bitsofcode - Optimising GIFs for the Web]]
...
As I mentioned, GIF compression algorithm is lossless. However, there are options for *lossy* compressions as well. Although this may sound like we will get visibly lower quality GIFs, lossy compression done well should not noticeably degrade the quality of the image.
