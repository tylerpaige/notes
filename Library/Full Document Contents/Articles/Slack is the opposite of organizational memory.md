...
## Metadata
- Author: [[Abe Winter]]
- Full Title: Slack is the opposite of organizational memory
- Category: #articles
- Publication date: 2018-02-11
- URL: https://abe-winter.github.io/plea's/help/2018/02/11/slack.html
- Summary: Slack creates constant interruptions and distractions, undermining teams' ability to think and plan effectively. It encourages a rushed communication style that prioritizes quick responses over thoughtful discussion, leading to poor documentation and fragmented ideas. Overall, its negative impact on productivity and organizational memory suggests that companies would benefit from moving away from chat tools like Slack.
