...
Summary: Reader is a keyboard-first reading app that lets you save, highlight, and annotate articles, PDFs, YouTube videos, and more. Install the browser extension and mobile apps to sync highlights, use text-to-speech, and navigate with shortcuts. Your content lives in Library (saved) or Feed (pushed), and the team updates the app often based on feedback.
---
