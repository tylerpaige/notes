---
Author: Linus Lee
Full Title: Knowledge tools, finite and infinite
Category:
Publication date: 2022-05-19
URL: https://thesephist.com/posts/infinite/
Summary: Knowledge tools can create a sense of infinite exploration by assembling ideas from finite sources. From basic note-taking apps to vast platforms like Google, there are varying degrees of finite and infinite knowledge access. Designing tools to autonomously search for new connections can transform note-taking into a generative and endless exploration experience.
---

![rw-book-cover](https://thesephist.com/favicon-32x32.png)

# Notes

[[thesephist.com - Knowledge tools, finite and infinite | thesephist.com]]
...
![A black-and-white view of a library, with a chair resting between tall bookshelves.](https://thesephist.com/img/library-bw.jpg)
...
Our tools should also **constantly look for novel connections between our own ideas**. In a sense, this is what the brain is doing constantly when thinking and dreaming, [searching for better paths through our idea maze](https://thesephist.com/posts/nav/). I would love to use a workspace into which I can put new ideas, and constantly discover connections between my thoughts and other people’s writings that I wouldn’t have noticed myself. I’ve built some [prototypes in the past that demonstrate its potential](https://thesephist.com/posts/hyperlink/).

A knowledge base that looked for new connections within itself would be less of a memory system, as notes conventionally are, and become more of a [*generative*](https://thesephist.com/posts/library/) tool. Generative tools are exciting because they contain real infinites that invite endless play and exploration.

I’m excited by the prospect of designing knowledge tools that feel *infinite*, that aren’t just repositories of information but interfaces to access a larger expanse of knowledge and generative worlds. Looking at technologies like GPT-3 and DALL-E 2, it seems like with more powerful tools of this kind, there’s also going to be more leverage placed on the [interfaces we use to harness their power](https://thesephist.com/posts/latent/). If we can get it right, researching and taking notes can become interesting acts of exploration, mapping the cognitive frontiers that await us at the end of infinities.
