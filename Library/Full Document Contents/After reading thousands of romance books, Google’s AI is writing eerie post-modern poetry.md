---
Author: John Dye
Full Title: After reading thousands of romance books, Google’s AI is writing eerie post-modern poetry
Category:
Publication date: 2016-05-12
URL: http://www.androidauthority.com/google-ai-poetry-692231/
Summary: Google let their AI read thousands of romance books then asked it to tell a simple story. The result is some fairly creepy poetry I wanted to kill him.
---

![rw-book-cover](https://www.androidauthority.com/favicon.ico)

# Notes

[[John Dye - After reading thousands of romance books, Google’s AI is writing eerie post-modern poetry]]

***

Google let their AI read thousands of romance books then asked it to tell a simple story. The result is some fairly creepy poetry: "I wanted to kill him."

![artificial intelligence](https://www.androidauthority.com/wp-content/uploads/2016/05/artificial-intelligence.jpg)
Google had a problem. Their AI engine spoke with grammatical precision and factual accuracy, but its diction remained terse and limp. They wanted it to be more conversational, so they [made it read 2,865 romance novels](https://www.androidauthority.com/google-ai-romance-novels-691082/). Now Google has a poet.

In an unpublished paper entitled “[Generating Sentences from a Continuous Space](http://arxiv.org/pdf/1511.06349.pdf),” researchers documented what the Google Brain Team’s pet AI had learned from its steamy binge-fest. The experimental parameters are simple and might actually make for a fun group writing game of some sort. The team gave the AI a starting sentence and an ending sentence. Then they asked artificial intelligence to bridge the two concepts using up to thirteen additional sentences. In a sense, they gave it a beginning and an end and asked it to tell a story. What came out was… a little strange. Take a look:
...
[Google is letting their AI engine read romance novels to make it more conversational](https://www.androidauthority.com/google-ai-romance-novels-691082/)
